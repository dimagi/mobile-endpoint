...
Revision ID: 40c898851bd3
Revises: None
Create Date: 2015-07-09 14:14:08.077760

"""

# revision identifiers, used by Alembic.
revision = '40c898851bd3'
down_revision = None
...
def upgrade():
    ...
    op.create_index('ix_case_index_referenced_id', 'case_index', ['referenced_id'], unique=False)

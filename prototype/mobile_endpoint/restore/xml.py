...
from mobile_endpoint.case.xml import check_version, V1
from mobile_endpoint.case.xml.generator import safe_element, get_generator, date_to_xml_string
...
def get_case_element(case, updates, version=V1):
    ...
    do_attach = False  # do_update TODO prototype: support attachments
    do_purge = const.CASE_ACTION_CLOSE in updates # or const.CASE_ACTION_PURGE in updates
    if do_create:
